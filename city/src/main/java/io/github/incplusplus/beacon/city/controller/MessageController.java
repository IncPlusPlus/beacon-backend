...
public class MessageController implements MessagesApi {
  ...
  public ResponseEntity<MessageDto> deleteMessage(
    ...
    return ResponseEntity.ok(messageService.deleteMessage(towerId, channelId, messageId));
  }
  ...
  public ResponseEntity<MessageDto> editMessage(
    ...
    // TODO: This lacks proper authorization checks. Someone messing with our API could delete the
    //  messages of another user. Fix that at some point.
    return ResponseEntity.ok(messageService.editMessage(towerId, channelId, messageId, messageDto));
  }
